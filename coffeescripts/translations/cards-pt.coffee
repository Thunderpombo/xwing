      ...
      #Torpedo
       ...
       #Título
        ...
        "Outrider":
           ...
           text: """Quando você realizar um ataque primário em alcance 3, role 1 dado de ataque adicional.%LINEBREAK%Quando você realizar um ataque obstruído, você podemudar um dos resultados %EVADE% do defensor para um resultado %FOCUS%.%LINEBREAK%Errata (desde a errata 1.8): carta com novo texto"</i>"""
        "Phantom":
